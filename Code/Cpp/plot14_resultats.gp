...
set output sprintf("%s/resultats_graph14.png", outdir)
...
plot "resultats/variation_Ca_c.txt" u 1:5 w l t "Ca_m", \
    "resultats/variation_Ca_c_10.txt" u 1:5 w l t "Ca_m"
...
plot "resultats/variation_Ca_c.txt" u 1:4 w l t "NADH_m", \
    "resultats/variation_Ca_c_10.txt" u 1:4 w l t "NADH_m"
...
plot "resultats/variation_Ca_c.txt" u 1:6 w l t "deltaPsi", \
    "resultats/variation_Ca_c_10.txt" u 1:6 w l t "deltaPsi"
...
plot "resultats/variation_Ca_c.txt" u 1:8 w l t "J_o", \
    "resultats/variation_Ca_c_10.txt" u 1:8 w l t "J_o"

#F: ATP
set title "ATP(t)"
set xlabel "temps"; set ylabel "ATP"
set yrange [2500:4000]
plot "resultats/variation_Ca_c.txt" u 1:7 w l t "ATP", \
    "resultats/variation_Ca_c_10.txt" u 1:7 w l t "ATP"
